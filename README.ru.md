...
* графики сейчас не поддерживаются, требуется рефакторинг бота. Есть реализованные графики по коммиту :* `68ac399d1c689f7ca0e62529d537f7c81e8da1c6`
...
За работоспособность данного метода установки не отвечаю, не тестировал \

- При нажатии F6 запускается таймер старта игры и лотусов соответсвенно
- При нажатии F7 оповестим ардуинку, что рошан умер
- При нажатии F8 переключится флаг, отвечающий за воспроизведение звуков (звук воспроизводится за 15 секунд до наступления любого из таймингов)\
